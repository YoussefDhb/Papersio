...
class UltraResearchWorkflow:
        ...
        try:
            ...
            if context.get("has_context"):
                ...
                return {
                    ...
                    "past_research": context["similar_queries"],
    ...
    async def _analyze_node(self, state: UltraResearchState) -> Dict:
        ...
        try:
            ...
            analysis = self.analyst.analyze_sources(
                state["query"],
                analysis_context
            )
    ...
    async def _critique_node(self, state: UltraResearchState) -> Dict:
        ...
        try:
            critique = self.critic.critique_report(
                state["query"],
    ...
    async def _save_node(self, state: UltraResearchState) -> Dict:
        ...
        try:
            ...
            if save_result.get("success"):
                ...
                return {
                    "saved_to_db": False,
                    "errors": [f"Save failed: {save_result.get('error')}"],
                    "current_stage": "save"
                }
        except Exception as e:
