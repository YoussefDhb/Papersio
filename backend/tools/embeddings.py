...
def get_or_create_collection(name: str):
    ...
    return chroma_client.get_or_create_collection(name=name, metadata={"hnsw:space": "cosine"})  # Use cosine similarity
...
def add_query_to_index(query_id: int, query_text: str) -> str:
    ...
    collection.add(embeddings=[embedding], documents=[query_text], ids=[embedding_id], metadatas=[{"query_id": query_id}])
...
def add_result_to_index(result_id: int, answer_text: str, query_text: str) -> str:
    ...
    collection.add(embeddings=[embedding], documents=[combined_text], ids=[embedding_id], metadatas=[{"result_id": result_id}])
